...
{
    public class XamOutlookGroupRegionAdapter : RegionAdapterBase<XamOutlookBar>
    {
        public XamOutlookGroupRegionAdapter(IRegionBehaviorFactory factory) : base(factory)
        {
